...
|                     | Modal window |  Browser-stored payment credentials | Streamlined authentication | 
|---------------------|------|-----|-----|
| *Pay (one PMI)      | Payment App |     |    | 
| Form fill + 3DS     | Merchant (OTP) |               |  Yes  |
| SRC via payment app | Payment App |               |  Maybe   | 
| SRC via browser     | Maybe Merchant |     Yes              |  Yes  |
| PayPal static creds | Maybe Merchant |    Yes   | Yes |
