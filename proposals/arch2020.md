...
* The controlling origin can learn (boolean) whether there are WebAuthn credentials associated with the credentail selected by the user via an event (before Payment Request has completed).
