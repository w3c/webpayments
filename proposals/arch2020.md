...
In a payment context (e.g., Payment Request):

* The controlling origin can enumerate controlled credentials (like cookies) in a 3p context.
* Other origins can only access a credential selected by the user.
